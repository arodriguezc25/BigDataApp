...
VERSION_APP = "Versión 2.3 del Junio 05 del 2025"
CREATOR_APP = "Andres Rodriguez/ https://github.com/arodriguezc25"
mongo_uri   = os.environ.get("MONGO_URI")

if not mongo_uri:
    #uri = "mongodb+srv://DbCentral:DbCentral2025@cluster0.vhltza7.mongodb.net/?appName=Cluster0"
    uri         = "mongodb+srv://arodriguezc12:DB_Ucentral2025@cluster0.fftcj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
    mongo_uri   = uri
...
client = Elasticsearch(
    "https://my-elasticsearch-project-d83ca4.es.us-east-1.aws.elastic.cloud:443",
    api_key="bnpSZE9KY0IxQzlwMklla0h2Uzg6VkhyX21fSmpkVndESGlMNnVpdkRMQQ=="
)
...
def contacto():
    if request.method == 'POST':
        ...
        try:
            ...
            if 'Contacto' not in db.list_collection_names():
                db.create_collection('Contacto')
            # Insertar el mensaje en la colección Contacto
